...
# 3-block VGG
def create_model_mn3():
	model = keras.Sequential()
	model.add(keras.layers.Conv2D(32, (3,3), activation = tf.nn.relu, kernel_initializer = 'he_uniform', padding='same', input_shape=(28,28,1)))
...
def main():
	...
	for train_index, test_index in skf.split(x, y):
		...
		print("*"*60)
		identifing_string = "two_vg_layers_mnist_100_{0}".format(counter)
		...
		# history = new_model.fit(train_x, train_y, epochs = 100, batch_size = 500, validation_data = (test_x, test_y))
